    ...
    <div>
      ...
      <main>
        ...
        <section className="projects__grid paginas-web">
          ...
          <div className="projects__item">
            <div className="project-card">
              <h3>AIO-An AI Based Advisor Web Application</h3>
              <p>Built an intelligent advisor platform that offers personalized advice, recommendations, and insights based on user input.</p>
              <a href="https://aio-5igz.onrender.com" className="custom-btn btn" target="_blank" rel="noopener noreferrer">View Project</a>
            </div>
          </div>
          <div className="projects__item">
            <div className="project-card">
              <h3>Lakshwear - Cloth E-commerce Website</h3>
              <p>Designed and developed a user-friendly e-commerce platform for a startup, enabling seamless shopping experiences with features like product browsing, secure checkout, and user accounts.</p>
              <a href="https://www.lakshwear.in/" className="custom-btn btn" target="_blank" rel="noopener noreferrer">View Project</a>
            </div>
          </div>
          <div className="projects__item">
            <div className="project-card">
              <h3>Online Game Lab</h3>
              <p>A fun personal project built to experiment with game logic and web interactivity. Hosted a collection of simple games in a browser-friendly format.</p>
              <a href="https://onlinegamelab.onrender.com/" className="custom-btn btn" target="_blank" rel="noopener noreferrer">View Project</a>
            </div>
          </div>
          <div className="projects__item">
            <div className="project-card">
